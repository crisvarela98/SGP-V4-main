document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function saveOrder(status) {
        ...
        const pedidoIdCompleto = `${vendedorCodigo}-${orderId}`;
        ...
        alert(`Pedido ${status} y guardado en localStorage con éxito.`);
    ...
    async function uploadOrdersToServer() {
        ...
        try {
            ...
            alert('Pedidos subidos con éxito al servidor en data/pedidos.json');
        } catch (error) {
